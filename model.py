...
from transformers import BertPreTrainedModel, BertModel,DebertaModel,DebertaPreTrainedModel
from transformers import LukeModel, LukePreTrainedModel,AlbertModel,AlbertPreTrainedModel


from transformers.modeling_outputs import (
    SequenceClassifierOutput
)
from transformers import AutoModel,MPNetPreTrainedModel,MPNetModel,GPT2PreTrainedModel,GPT2Model,GPT2ForSequenceClassification
...
# class BertForKBCSequenceClassification(DebertaPreTrainedModel):
# class BertForKBCSequenceClassification(LukePreTrainedModel):
class BertForKBCSequenceClassification(BertPreTrainedModel):
# class BertForKBCSequenceClassification(GPT2PreTrainedModel):
# class BertForKBCSequenceClassification(MPNetPreTrainedModel):
    def __init__(self, config):
        ...
        # self.bert = LukeModel(config)
        # self.bert = GPT2Model(config)
        ...
        # self.embedding_relation = torch.nn.Embedding(self.ntoken * 238, config.embedding_size)
