...
if __name__ == '__main__':
    ...
    if not params.bertrl_output_dir:
        params.bertrl_output_dir = f'{params.main_dir}/output_{params.dataset}{params.additional_suffix}'

    res = np.load(f'{params.bertrl_output_dir}/test_results_prediction_scores.npy')
