...
export MODEL_SUFFIX="_hop3_full_neg10_max_inductive"
export DATA_SUFFIX="_hop3_full_neg10_max_inductive"
export OUTPUT_SUFFIX="_hop3_full_neg10_max_inductive_new"  
